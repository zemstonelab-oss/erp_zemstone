...
import BranchShipmentStatsPage from './pages/BranchShipmentStatsPage';
  ...
  return (
    <Routes>
      ...
      <Route element={<Layout />}>
        ...
        <Route path="/branch-stats" element={
          <RoleGuard roles={['ADMIN', 'HQ']}><BranchShipmentStatsPage /></RoleGuard>
        } />
